// code_generator_tag
// constants:3cd5169cf7a0c752bba320950657366f types:f8cc0cfbfc3a122a6fc303207f17cb3c template:e3fd0e61c5b8727361552db76c1636b8 code:26247b4dec6b234e1cce56474778907e
...
struct TRADE_API ATPOrderQueryConditionConst
{
	...
	static const ATPOrderQueryConditionType AllExceptInRejOrd = 5;	///<全部委托（不含TE内部拒单）
...
struct TRADE_API ATPQueryResultCodeConst
{
	...
	static const ATPQueryResultCodeType kTradeOrderQueryConditionIllegal = 78;	///<成交查询条件入参非法
...
struct TRADE_API ATPPermissonErrorCodeTypeConst
{
	...
	static const ATPPermissonErrorCodeType kPwdError = 4;	///<用户名或密码错误
...
struct TRADE_API ATPRejectReasonCodeConst
{
	...
	static const ATPRejectReasonCodeType kAccountIDNonExist = 26;	///<找不到账户，请补充或修改传入的账户相关信息
	...
	static const ATPRejectReasonCodeType kExchangeReject = 100;	///<订单被拒绝，详细的拒单代码见OrdRejReason字段
	...
	static const ATPRejectReasonCodeType kGwUserFunctionNoCheckFailed = 243;	///<网关用户级功能号禁止
	static const ATPRejectReasonCodeType kClientFeatureCodeCheckFailed = 253;	///<终端识别码管控不通过
	static const ATPRejectReasonCodeType kAmiReturnError = 262;	///<AMI返回错误
	...
	static const ATPRejectReasonCodeType kTibOrderPriceRangOut = 1052;	///<股票市价委托的保护价在价格范围之外
	...
	static const ATPRejectReasonCodeType kFundAccountIDNotAllowMarketPriceOrder = 1277;	///<该资金账户不允许市价委托
...
struct TRADE_API ATPOrdRejReasonConst
{
	...
	static const ATPOrdRejReasonType kNoCodec;	///<无对应的交易所协议和业务类型编码
	static const ATPOrdRejReasonType kRejectReoffer;	///<报盘通道重启请重新申报
	static const ATPOrdRejReasonType kInternalReject;	///<订单被手动发起内部拒单处理
...
{
	static const ATPErrorCodeTypeType kOrdRejReason = 1;	///<ORS/COS拒绝原因错误码类型
...
struct TRADE_API ATPMultiChannelFlagTypeConst
{
	...
	static const ATPMultiChannelFlagType kAllSubscribe = 2;	///<订阅，客户所有主推
...
* @brief 消息订阅枚举
*/
struct TRADE_API ATPMultiChannelFlagTypeCustConst
{
	static const ATPMultiChannelFlagType kDefault = 255;	///<默认值
	static const ATPMultiChannelFlagType kSubscribe = 1;	///<订阅
	static const ATPMultiChannelFlagType kNoSubscribe = 0;	///<不订阅
...
* @brief 成交查询条件枚举
*/
struct TRADE_API ATPTradeOrderQueryConditionConst
{
	static const ATPTradeOrderQueryConditionType kDefault = 0xFF;	///<默认值
	static const ATPTradeOrderQueryConditionType kGlobalParams = 0;	///<按系统内部设置的参数进行结果返回，详情请与券商确认
	static const ATPTradeOrderQueryConditionType kTradeReport = 1;	///<仅查询成交回报
	static const ATPTradeOrderQueryConditionType kTradeReportAndCancleSuccess = 2;	///<查询成交回报、撤单成功消息
	static const ATPTradeOrderQueryConditionType kAllAvailable = 3;	///<查询成交回报、撤单成功消息、委托拒单消息、撤单拒单消息
	static bool IsValid(const ATPTradeOrderQueryConditionType& value);

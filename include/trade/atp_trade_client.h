// code_generator_tag
// requests:63056ba88a9f04b6b89ac5f87ef0a326 template:2e771cb107df25e1ca1cd3fd5c99e47d code:23a594ebb32d87e78eff6c0cb2c8ab38
...
class TRADE_API ATPTradeAPI
{
    ...
    public:
         ...
         *	@param[in]	multi_channel_flag 回报消息主动订阅参数 0 取消 1 订阅 2-主动订阅当前客户所有连接 默认0xFF
         *	@return		返回连接函数错误码
         ...
         * @business   cash,margin
         * @type       cancel
         * @note       支持以下业务类型的撤单：盘后定价交易、债券分销、现货交易、ETF、盘后定价（科创板、创业板）交易业务、港股通买卖、港股通公司行为、网上发行认购、网络投票、质押式回购、配售业务、分级基金分拆合并、债券转股回售、要约收购、权证行权<br/>按“客户自定义委托批号”处理撤单时，若找不到对应原订单、或因其他原因撤单请求被拒绝,ATP不会生成Ack响应消息。
         */

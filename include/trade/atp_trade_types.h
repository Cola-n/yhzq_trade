// code_generator_tag
// types:f8cc0cfbfc3a122a6fc303207f17cb3c template:3193722197a4f5b21a92934cfb63f986 code:96f5adfcc18998a5223f555d1833dd5a
...
typedef char ATPPasswordType[501];    ///< 密码
...
typedef uint64_t ATPBatchClOrdNoType;    ///< 客户自定义委托批号
typedef char ATPCustNameType[256];    ///< 客户名
typedef uint8_t ATPTradeOrderQueryConditionType;    ///< 成交查询条件
typedef char ATPOrderWayExtType[5];    ///< 扩位委托方式
typedef char ATPNoProfitType;    ///< 是否尚未盈利
typedef char ATPWeightedVotingRightsType;    ///< 是否存在表决权差异
typedef char ATPIsRegistrationType;    ///< 是否注册制
typedef char ATPIsVieType;    ///< 是否具有协议控制架构
